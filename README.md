...
- **Expense (Out-of-Pocket)**: Capital injections tracked as member equity contributions
- **Reporting**: Automatic calculation of Cash on Hand, Total Capital, and Net Profit
...
- [ ] Implement database schema:
  ...
  - `transactions` table with type discrimination
...
- [ ] Implement transaction input form with:
  - Transaction type selector (Income, Expense-Business, Expense-Out-of-Pocket)
  - Amount input
  - Description/notes
  - Date picker
  - Category selector
- [ ] Add transaction list view with filtering/sorting
- [ ] Implement transaction edit/delete functionality
...
- [ ] Implement basic charts (monthly income/expense trends)
...
- **Audit Logging**: Track all financial transactions with timestamps
...
- **Financial Integrity**: Calculation accuracy, audit log completeness

...
import { addIncomeForMember } from "../actions"
...
type AddRegularIncomeSheetProps = {
...
export function AddRegularIncomeSheet({
  organizationId,
  members,
  currentUserEmail,
  currentUserId,
}: AddRegularIncomeSheetProps) {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    startTransition(async () => {
      const result = await addIncomeForMember({
        organizationId,
        amount: parsedAmount,
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      <SheetContent side="right">
        <SheetHeader>
          <SheetTitle>Add Income for Member</SheetTitle>
          <SheetDescription>
            Record regular income and assign who holds the funds.
          </SheetDescription>
        </SheetHeader>
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Choose the holder of business funds for this income.
            </p>
          </div>

...
export default function AuthPage() {
  ...
  return (
    <div className="grid min-h-[75vh] gap-8 lg:grid-cols-[1.05fr,0.95fr]">
      <div className="relative overflow-hidden rounded-3xl border border-border/70 bg-gradient-to-br from-accent-muted/80 via-card to-background shadow-sm">
      ...
      <Card className="backdrop-blur">
        <CardHeader className="space-y-2">
          ...
          <CardDescription>Use the email and password you created for OrgFinance.</CardDescription>
        </CardHeader>
        <CardContent>
